   ...
   <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow"><a
         ...
         aria-expanded="false"> <span
            class="mr-2 d-none d-lg-inline text-gray-600 small">${sessionScope.loginInfo.userNickName}님 환영합니다.</span> <img class="img-profile rounded-circle"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary" href="/up/member/login.do">Logout</a>
				</div>
			</div>
		</div>
	</div>
