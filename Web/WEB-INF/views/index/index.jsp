		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content" class="container-fluid-background">
				...
				<div class="container-fluid">
					...
					<br>
					<div class="container">
						<h1 class="h5 text-white text-center">당신의 발현되지 못한 잠재력을</h1>
					</div>
					<div class="container">
						<h1 class="h5 text-white text-center">이끌어 드립니다</h1>
					</div>
					<div class="container">
					...
					<div class="container gold">
						<h1 class="h6 text-center">- 도스토예프스키</h1>
					</div>
					<br>
					<div class="container">
						<h1 class="h6 text-center text-gray-500">어릴 적부터 우리는 좋은 습관을
							만들기 위해 많은 노력을 합니다</h1>
					</div>
					<div class="container">
						<h1 class="h6 text-center text-gray-500">세상에는 습관에 대한 많은 명언들이
							있고, 성공한 많은 사람들이 자신의 성공 비결을 습관에서 나온다고 말합니다</h1>
					</div>

					<div class="container">
						<h1 class="h6 text-center text-gray-500">습관의 중요성에 대한 글들이 만연하고
							실제로 알고 있음에도 그것을 실천하기는 매우 어렵습니다</h1>
					</div>
					<div class="container">
						<h1 class="h6 text-center text-gray-500">왜냐하면 우리는 무의적으로 눈에
							보이는 보상과 결과가 있어야 강한 동기부여가 되며</h1>
					</div>
					<div class="container">
						<h1 class="h6 text-center text-gray-500">실천에 옮기는 힘이 커지기 때문입니다</h1>
					</div>
					<div class="container">
						<h1 class="h6 text-center text-gray-500">좋은 습관을 들이고 싶은 당신에게</h1>
					</div>
					<div class="container">
						<h1 class="h6 text-center text-gray-500">
